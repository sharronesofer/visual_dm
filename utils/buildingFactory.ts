...
import { validateBuildingBase, validateSocialBuilding, validateDungeonStructure, validateExplorationFeature } from './buildingValidation';

// Base factory function
export function createBuildingBase(props: Partial<BuildingBase>): BuildingBase {
...
// Social building factories
export function createInn(props: Partial<Inn>): Inn {
...
export function createShop(props: Partial<Shop>): Shop {
  const baseBuilding = createBuildingBase({
    ...props,
...
export function createTavern(props: Partial<Tavern>): Tavern {
  const baseBuilding = createBuildingBase({
    ...props,
...
export function createGuildHall(props: Partial<GuildHall>): GuildHall {
  const baseBuilding = createBuildingBase({
    ...props,
...
export function createNPCHome(props: Partial<NPCHome>): NPCHome {
  const baseBuilding = createBuildingBase({
    ...props,
...
// Dungeon structure factories
export function createEnemyLair(props: Partial<EnemyLair>): EnemyLair {
  const baseBuilding = createBuildingBase({
    ...props,
...
export function createPuzzleRoom(props: Partial<PuzzleRoom>): PuzzleRoom {
  const baseBuilding = createBuildingBase({
    ...props,
...
// Exploration feature factories
export function createRuins(props: Partial<Ruins>): Ruins {
  const baseBuilding = createBuildingBase({
    ...props,
...
export function createResourceNode(props: Partial<ResourceNode>): ResourceNode {
  const baseBuilding = createBuildingBase({
    ...props,
