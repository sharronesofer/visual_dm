...
import { IBulkService } from '../interfaces/bulk.interface';
import { ServiceResponse, ServiceEventType } from '../types/common';

/**
 * Abstract bulk service class that extends BaseService and implements IBulkService
 */
export abstract class BulkService<T extends BaseEntity> extends BaseService<T> implements IBulkService<T> {
  // Abstract methods for bulk operations
