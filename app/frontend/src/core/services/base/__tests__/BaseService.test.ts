...
// Mock implementation of BaseService
class TestService extends BaseService<TestEntity> {
  ...
  protected async executeFindById(id: string | number, transaction?: Transaction): Promise<TestEntity | null> {
    if (id === '1') {
      return {
        id: '1',
        name: 'Test Entity',
  ...
  protected async executeFindAll(options?: { limit?: number; offset?: number }, transaction?: Transaction): Promise<TestEntity[]> {
    return [
      {
        id: '1',
        name: 'Test Entity 1',
  ...
  protected async executeUpdate(id: string | number, data: Partial<TestEntity>, transaction?: Transaction): Promise<TestEntity> {
    return {
      id: id.toString(),
      name: data.name!,
      createdAt: new Date(),
  ...
  protected async executeDelete(id: string | number, transaction?: Transaction): Promise<void> {
    // Mock implementation
  }
}
