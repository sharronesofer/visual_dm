 ...
 */
export class POIService extends BasePaginatedService<
  POI,
  POICreateDTO,
  POIUpdateDTO
> {
  ...
  async getChunk(x: number, y: number): Promise<ServiceResponse<POIChunk>> {
  ...
  async getEntity(id: string): Promise<ServiceResponse<POIEntity>> {
  ...
  // Search methods
  async searchByName(name: string): Promise<ServiceResponse<POI[]>> {
  ...
  async getPOI(id: string): Promise<ServiceResponse<POI>> {
  ...
  async deletePOI(id: string): Promise<ServiceResponse<void>> {
