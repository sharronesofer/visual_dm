import POIGenerationService from '../src/services/POIGenerationService';
...
export async function runBenchmark(cfg = config) {
  const times: number[] = [];
...
// For CI/CD: run with `node tools/benchmarkPOIGeneration.js dungeon large medieval 0.7 10 benchmark-seed` 