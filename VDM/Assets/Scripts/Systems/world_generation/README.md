...
This directory contains the Unity frontend implementation for the WorldGeneration system, mirroring the backend/systems/WorldGeneration structure.
...
- Backend: backend/systems/worldgeneration
