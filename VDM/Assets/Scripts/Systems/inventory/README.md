...
This directory contains the Unity frontend implementation for the Inventory system, mirroring the backend/systems/Inventory structure.
...
- Backend: backend/systems/inventory
