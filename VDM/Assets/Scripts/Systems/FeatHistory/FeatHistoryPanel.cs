...
namespace VisualDM.Systems.FeatHistory
{
    public class FeatHistoryPanel : MonoBehaviour
    {
        ...
        private void BuildUI()
        {
            ...
            // Search Field
            searchField = new GameObject("SearchField").AddComponent<CoreField>();
        ...
        private void RefreshUI()
        {
            ...
            foreach (var rec in recs)
            {
                ...
                acceptBtn.onClick.AddListener(() => recommender.RecordSystems(characterId, rec.Id, true));
                // Ignore button
                ...
                ignoreBtn.onClick.AddListener(() => recommender.RecordSystems(characterId, rec.Id, false));
                y += 40;
            }
        }
