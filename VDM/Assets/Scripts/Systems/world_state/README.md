...
This directory contains the Unity frontend implementation for the WorldState system, mirroring the backend/systems/WorldState structure.
...
- Backend: backend/systems/worldstate
