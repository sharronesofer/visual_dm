...
This directory contains the Unity frontend implementation for the Crafting system, mirroring the backend/systems/Crafting structure.
...
- Backend: backend/systems/crafting
