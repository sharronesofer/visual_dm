...
namespace VisualDM.UI
{
    ...
    public class RegisterUI : MonoBehaviour
    {
        ...
        [SerializeField] private TMP_CoreField emailField;
        [SerializeField] private TMP_CoreField passwordField;
        [SerializeField] private TMP_CoreField confirmPasswordField;
        [SerializeField] private TMP_CoreField firstNameField;
        [SerializeField] private TMP_CoreField lastNameField;
