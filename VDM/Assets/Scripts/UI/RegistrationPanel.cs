    ...
    public class RegistrationPanel : PanelBase
    {
        ...
        public override void Initialize(params object[] args)
        {
            try
            {
                ...
                var confirmCore = confirmPasswordField.AddComponent<UI.Components.CoreField>();
                confirmCore.Placeholder = "Re-enter password";
                confirmCore.IsPassword = true;
                confirmCore.OnValueChanged = (val) => { };
