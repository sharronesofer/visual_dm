...
{
    public class VisualSystemsModule : MonoBehaviour, ISystemsModule
    {
        ...
        private void Awake()
        {
            ...
            {
                var go = new GameObject("SystemsParticle");
        ...
        private void SpawnParticle(ActionType type, int importance, Vector2 position, SystemsConfig config)
        {
        ...
        private System.Collections.IEnumerator FadeOut(GameObject go, float duration, SystemsConfig config)
        {
            var sr = go.GetComponent<SpriteRenderer>();
            float t = 0f;
        ...
        private Color GetColorForImportance(int importance, SystemsConfig config)
        {
        ...
        private void StartScreenShake(int importance, SystemsConfig config)
        {
