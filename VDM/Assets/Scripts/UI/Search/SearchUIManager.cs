...
namespace VisualDM.UI
{
    public class SearchUIManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            searchCore = CreateComponent<SearchCore>("SearchCore");
            ...
            // Layout
            searchCore.transform.position = new Vector3(100, 600, 0);
            ...
            // Wire up events
            searchCore.OnSearchSubmitted += OnSearchSubmitted;
            searchCore.OnSuggestionSelected += OnSuggestionSelected;
