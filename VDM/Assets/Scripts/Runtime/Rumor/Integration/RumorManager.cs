...
using VDM.Runtime.Rumor.Models;
using VDM.Runtime.Rumor.Services;
using VDM.Runtime.Rumor.UI;


namespace VDM.Runtime.Rumor.Integration
{
    /// <summary>
    ...
    public class RumorManager : SystemManager
    {
        ...
        public override string SystemVersion => "1.0.0";
        ...
        protected override async Task ShutdownSystemAsync()
        {
            try
            {
