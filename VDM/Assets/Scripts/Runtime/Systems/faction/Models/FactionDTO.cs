...
namespace VDM.Systems.Faction.Models
{
    /// <summary>
    ...
    /// <summary>
    /// Basic Faction DTO alias for FactionResponseDTO
    /// Used for simple faction references
    /// </summary>
    [Serializable]
    public class FactionDTO : FactionResponseDTO
    {
        public FactionDTO() : base() { }
    }
} 