...
namespace VDM.Systems.Combat.Ui
{
    ...
    public class CombatUIController : UIController
    {
        ...
        private List<VDM.DTOs.Combat.CombatActionDTO> _availableActions = new List<VDM.DTOs.Combat.CombatActionDTO>();
        private string _selectedTargetId;
        
        // Events
        public event Action<VDM.DTOs.Combat.CombatActionDTO, string> OnActionSelected;
        ...
        /// </summary>
        public async void ExecuteAction(VDM.DTOs.Combat.CombatActionDTO action, string targetId = null)
        {
            if (string.IsNullOrEmpty(_currentCombatId))
            {
        ...
        private void UpdateActionsUI(List<VDM.DTOs.Combat.CombatActionDTO> actions)
        {
        ...
        private VDM.DTOs.Combat.CombatActionDTO _selectedAction;
        ...
        private void HandleActionsUpdated(string combatantId, List<VDM.DTOs.Combat.CombatActionDTO> actions)
        {
