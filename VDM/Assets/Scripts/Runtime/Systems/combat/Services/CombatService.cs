...
namespace VDM.Systems.Combat.Services
{
    ...
    public class CombatService : BaseHttpService
    {
        ...
        /// </summary>
        public async Task<CombatResult> SubmitActionAsync(string combatId, string actorId, VDM.DTOs.Combat.CombatActionDTO action, string targetId = null)
        {
            var request = new
            {
                combat_id = combatId,
        ...
        /// </summary>
        public async Task<List<VDM.DTOs.Combat.CombatActionDTO>> GetAvailableActionsAsync(string combatId, string combatantId)
        {
            try
            {
