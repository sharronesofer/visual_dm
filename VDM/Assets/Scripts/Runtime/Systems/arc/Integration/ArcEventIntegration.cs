...
namespace VDM.Systems.Arc.Integration
{
    ...
    public class QuestCompletedEvent : IEvent
    {
        ...
        public string EventType { get; set; } = "quest_completed";
        public DateTime Timestamp { get; set; } = DateTime.UtcNow;
        public string Source { get; set; } = "Arc.Integration";
    ...
    public class QuestStartedEvent : IEvent
    {
        ...
        // IEvent implementation
        public string EventId { get; set; } = Guid.NewGuid().ToString();
        public string EventType { get; set; } = "quest_started";
        public DateTime Timestamp { get; set; } = DateTime.UtcNow;
        public string Source { get; set; } = "Arc.Integration";
        public EventPriority Priority { get; set; } = EventPriority.Normal;
    }
    
    public class CharacterRelationshipChangedEvent : IEvent
    {
        ...
        // IEvent implementation
        public string EventId { get; set; } = Guid.NewGuid().ToString();
        public string EventType { get; set; } = "character_relationship_changed";
        public DateTime Timestamp { get; set; } = DateTime.UtcNow;
        public string Source { get; set; } = "Arc.Integration";
        public EventPriority Priority { get; set; } = EventPriority.Normal;
    }
    
    public class CharacterChoiceMadeEvent : IEvent
    {
        public string CharacterId { get; set; }
        ...
        // IEvent implementation
        public string EventId { get; set; } = Guid.NewGuid().ToString();
        public string EventType { get; set; } = "character_choice_made";
        public DateTime Timestamp { get; set; } = DateTime.UtcNow;
        public string Source { get; set; } = "Arc.Integration";
        public EventPriority Priority { get; set; } = EventPriority.Normal;
    }
    
    public class FactionWarStartedEvent : IEvent
    {
        ...
        // IEvent implementation
        public string EventId { get; set; } = Guid.NewGuid().ToString();
        public string EventType { get; set; } = "faction_war_started";
        public DateTime Timestamp { get; set; } = DateTime.UtcNow;
        public string Source { get; set; } = "Arc.Integration";
        public EventPriority Priority { get; set; } = EventPriority.Normal;
    }
    
    public class FactionAllianceFormedEvent : IEvent
    {
        ...
        // IEvent implementation
        public string EventId { get; set; } = Guid.NewGuid().ToString();
        public string EventType { get; set; } = "faction_alliance_formed";
        public DateTime Timestamp { get; set; } = DateTime.UtcNow;
        public string Source { get; set; } = "Arc.Integration";
        public EventPriority Priority { get; set; } = EventPriority.Normal;
    }
    ...
    public class WorldStateChangedEvent : IEvent
    {
        ...
        // IEvent implementation
        public string EventId { get; set; } = Guid.NewGuid().ToString();
        public string EventType { get; set; } = "world_state_changed";
        public DateTime Timestamp { get; set; } = DateTime.UtcNow;
        public string Source { get; set; } = "Arc.Integration";
        public EventPriority Priority { get; set; } = EventPriority.Normal;
    }
    ...
    public class RegionConqueredEvent : IEvent
    {
        ...
        // IEvent implementation
        public string EventId { get; set; } = Guid.NewGuid().ToString();
        public string EventType { get; set; } = "region_conquered";
        public DateTime Timestamp { get; set; } = DateTime.UtcNow;
        public string Source { get; set; } = "Arc.Integration";
        public EventPriority Priority { get; set; } = EventPriority.Normal;
    }
    
    public class SeasonChangedEvent : IEvent
    {
        ...
        // IEvent implementation
        public string EventId { get; set; } = Guid.NewGuid().ToString();
        public string EventType { get; set; } = "season_changed";
        public DateTime Timestamp { get; set; } = DateTime.UtcNow;
        public string Source { get; set; } = "Arc.Integration";
        public EventPriority Priority { get; set; } = EventPriority.Normal;
    }
    
    public class YearPassedEvent : IEvent
    {
        public int Year { get; set; }
        ...
        // IEvent implementation
        public string EventId { get; set; } = Guid.NewGuid().ToString();
        public string EventType { get; set; } = "year_passed";
        public DateTime Timestamp { get; set; } = DateTime.UtcNow;
        public string Source { get; set; } = "Arc.Integration";
        public EventPriority Priority { get; set; } = EventPriority.Normal;
    }
    
    public class NarrativeChoiceEvent : IEvent
    {
        public string ChoiceId { get; set; }
        ...
        // IEvent implementation
        public string EventId { get; set; } = Guid.NewGuid().ToString();
        public string EventType { get; set; } = "narrative_choice";
        public DateTime Timestamp { get; set; } = DateTime.UtcNow;
        public string Source { get; set; } = "Arc.Integration";
        public EventPriority Priority { get; set; } = EventPriority.Normal;
    }
    
    public class StoryBranchEvent : IEvent
    {
        public string ArcId { get; set; }
        ...
        // IEvent implementation
        public string EventId { get; set; } = Guid.NewGuid().ToString();
        public string EventType { get; set; } = "story_branch";
        public DateTime Timestamp { get; set; } = DateTime.UtcNow;
        public string Source { get; set; } = "Arc.Integration";
        public EventPriority Priority { get; set; } = EventPriority.Normal;
    }
