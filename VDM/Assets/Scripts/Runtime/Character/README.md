...
This directory contains the Unity frontend implementation for the Character system, mirroring the backend/systems/Character structure.
...
- Backend: backend/systems/character
