...
using VDM.Runtime.Analytics.Services;
using VDM.Runtime.UI.Framework;


namespace VDM.Runtime.Analytics.UI
{
    /// <summary>
    ...
    public class AnalyticsDashboard : BaseUIComponent
    {
        ...
        private void Update()
        {
            ...
            if (autoRefreshToggle.isOn && Time.time - lastAutoRefresh >= autoRefreshInterval)
            {
                RefreshDashboard();
