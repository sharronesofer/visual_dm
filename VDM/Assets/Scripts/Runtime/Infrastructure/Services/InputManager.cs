    ...
    public class InputManager : MonoBehaviour
    {
        ...
        private void HandleKeyHold(string actionName, InputAction action)
        {
            ...
            if (isPressed)
            {
                ...
                {
                    keyHoldStartTimes[actionName] = UnityEngine.Time.time;
                }
                
                float holdTime = UnityEngine.Time.time - keyHoldStartTimes[actionName];
        ...
        private void HandleTouchInput()
        {
            ...
            foreach (Touch touch in Input.touches)
            {
                ...
                var touchData = new TouchData
                {
                    ...
                    phase = touch.phase,
                    startTime = touchStartTimes.GetValueOrDefault(touch.fingerId, UnityEngine.Time.time)
                };
        ...
        private void HandleTouchStart(TouchData touchData)
        {
            ...
            touchStartTimes[touchData.fingerId] = UnityEngine.Time.time;
        ...
        private void HandleTouchEnd(TouchData touchData)
        {
            if (touchStartPositions.TryGetValue(touchData.fingerId, out var startPos))
            {
                ...
                float duration = UnityEngine.Time.time - touchStartTimes[touchData.fingerId];
