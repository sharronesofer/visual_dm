...
using System;
using UnityEngine;
using VDM.Runtime.WorldState.Models;
using VDM.Runtime.Http;


namespace VDM.Runtime.WorldState.Services
{
    /// <summary>
    ...
    public class WorldStateService : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (httpService == null)
            {
                Debug.LogError("WorldStateService requires HttpService to be present in the scene");
            }
        }
        ...
        public async Task<WorldStateResponse<WorldRegion>> CreateRegionAsync(WorldRegion region)
        {
            try
            {
                ...
                var response = await httpService.PostAsync<WorldStateResponse<WorldRegion>>(url, region);
                return response;
            }
            catch (Exception ex)
            {
        ...
        public async Task<WorldStateResponse<WorldRegion>> UpdateRegionAsync(string regionId, WorldRegion region)
        {
            try
            {
                ...
                var response = await httpService.PutAsync<WorldStateResponse<WorldRegion>>(url, region);
                return response;
            }
            catch (Exception ex)
            {
        ...
        public async Task<WorldStateResponse<bool>> SetRegionStateAsync(string regionId, StateCategory category, Dictionary<string, object> stateData)
        {
            try
            {
                ...
                var response = await httpService.PutAsync<WorldStateResponse<bool>>(url, stateData);
                return response;
            }
            catch (Exception ex)
            {
        ...
        public async Task<WorldStateResponse<bool>> UpdateRegionStateAsync(string regionId, StateCategory category, Dictionary<string, object> updates)
        {
            try
            {
                ...
                var response = await httpService.PatchAsync<WorldStateResponse<bool>>(url, updates);
                return response;
            }
            catch (Exception ex)
            {
        ...
        public async Task<WorldStateResponse<WorldMap>> CreateMapAsync(WorldMap map)
        {
            try
            {
                ...
                var response = await httpService.PostAsync<WorldStateResponse<WorldMap>>(url, map);
                return response;
            }
            catch (Exception ex)
            {
        ...
        public async Task<WorldStateResponse<WorldStateSnapshot>> CreateSnapshotAsync(CreateSnapshotRequest request)
        {
            try
            {
                ...
                var response = await httpService.PostAsync<WorldStateResponse<WorldStateSnapshot>>(url, request);
                return response;
            }
            catch (Exception ex)
            {
        ...
        public async Task<WorldStateResponse<bool>> RestoreSnapshotAsync(RestoreSnapshotRequest request)
        {
            try
            {
                ...
                var response = await httpService.PostAsync<WorldStateResponse<bool>>(url, request);
                return response;
            }
            catch (Exception ex)
            {
