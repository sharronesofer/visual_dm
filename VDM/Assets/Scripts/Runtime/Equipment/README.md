...
This directory contains the Unity frontend implementation for the Equipment system, mirroring the backend/systems/Equipment structure.
...
- Backend: backend/systems/equipment
