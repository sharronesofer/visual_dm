...
This directory contains the Unity frontend implementation for the Region system, mirroring the backend/systems/Region structure.
...
- Backend: backend/systems/region
