...
namespace VDM.Runtime.Combat
{
    ...
    public class CombatManager
    {
        ...
        /// </summary>
        private ActionResult ProcessAction(CombatAction action)
        {
        ...
        /// </summary>
        private ActionResult ProcessAttack(CombatAction action)
        {
            var result = new ActionResult();
        ...
        /// </summary>
        private ActionResult ProcessDefend(CombatAction action)
        {
            var result = new ActionResult
            {
                Success = true,
        ...
        /// </summary>
        private ActionResult ProcessCast(CombatAction action)
        {
            var result = new ActionResult
            {
                Success = true,
        ...
        /// </summary>
        private ActionResult ProcessMove(CombatAction action)
        {
            var result = new ActionResult
            {
                Success = true,
    ...
    public class CombatAction
    {
        ...
        public CombatAction(CombatActionType type, Combatant actor, Combatant target = null)
        {
            Type = type;
            Actor = actor;
            Target = target;
