...
using System;
using UnityEngine;
using VDM.Runtime.Core.Services.WebSocket;
using VDM.Runtime.Economy.Models;


namespace VDM.Runtime.Economy.Services
{
    /// <summary>
    ...
    public class EconomyWebSocketHandler : BaseWebSocketHandler
    {
        ...
        public override void Initialize(string serverUrl)
        {
            base.Initialize(serverUrl);
        ...
        protected override void HandleMessage(string channel, string message)
        {
            try
            {
                ...
                {
                    Debug.LogWarning($"Economy WebSocket message missing type field: {message}");
                    return;
                }
