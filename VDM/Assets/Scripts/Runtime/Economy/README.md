...
This directory contains the Unity frontend implementation for the Economy system, mirroring the backend/systems/Economy structure.
...
- Backend: backend/systems/economy
