        ...
        protected override void HandleMessage(WebSocketMessage message)
        {
            try
            {
                switch (message.Type)
                {
                    ...
                    case "arc_created":
                        HandleArcCreated(message);
                        break;
                    case "arc_updated":
                        HandleArcUpdated(message);
                        break;
                    case "arc_deleted":
                        HandleArcDeleted(message);
                        break;
                    case "arc_started":
                        HandleArcStarted(message);
                        break;
                    case "arc_completed":
                        HandleArcCompleted(message);
                        break;
                    case "arc_failed":
                        HandleArcFailed(message);
                        break;
                    case "arc_stalled":
                        HandleArcStalled(message);
                        break;
                    ...
                    case "progression_updated":
                        HandleProgressionUpdated(message);
                        break;
                    case "milestone_reached":
                        HandleMilestoneReached(message);
                        break;
                    case "arc_phase_changed":
                        HandleArcPhaseChanged(message);
                        break;
                    
                    // Integration events
                    case "quest_opportunity_created":
                        HandleQuestOpportunityCreated(message);
                        break;
                    case "arc_quest_linked":
                        HandleArcQuestLinked(message);
                        break;
                    case "character_joined_arc":
                        HandleCharacterJoinedArc(message);
                        break;
                    case "character_left_arc":
                        HandleCharacterLeftArc(message);
                        break;
                    
                    default:
                        Debug.LogWarning($"Unknown arc message type: {message.Type}");
                        break;
                }
            }
            catch (Exception ex)
