...
This directory contains the Unity frontend implementation for the Faction system, mirroring the backend/systems/Faction structure.
...
- Backend: backend/systems/faction
