...
class ImportPathFixer:
    ...
    def __init__(self, project_root: str = "."):
        ...
        self.path_mappings = {
            ...
            r'data/abilities/abilities_fully_finalized_schema\.json': 'data/builders/content/abilities/abilities.json',
            r'data/feats/feats_fully_finalized_schema\.json': 'data/builders/content/abilities/abilities_legacy.json',
