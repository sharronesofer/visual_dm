...
class TypedEventEmitter<Events extends Record<string | symbol, any>> extends EventEmitter {
   ...
   */
  public listenerCount<E extends keyof Events>(event: E): float {
   ...
   * @returns The instance of the emitter for chaining
   */
  public setMaxListeners(n: float): this {
   ...
   * @returns The instance of the emitter for chaining
   */
  public addListeners(events: Dict[str, Any]): this {
   ...
   * @returns The instance of the emitter for chaining
   */
  public removeListeners(events: Dict[str, Any]): this {
    Object.entries(events).forEach(([event, listener]) => {
      if (listener) {
