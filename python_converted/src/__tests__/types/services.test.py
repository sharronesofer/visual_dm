...
describe('Service Types', () => {
  ...
  describe('Extended Services', () => {
    it('should type check CachedService', () => {
      TestCachedService = CachedService[TestEntity]
    ...
    it('should type check RetryableService', () => {
      TestRetryableService = RetryableService[TestEntity]
    ...
    it('should type check RealtimeService', () => {
      TestRealtimeService = RealtimeService[TestEntity]
