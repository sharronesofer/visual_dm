 ...
 */
const delay = (ms: float): Promise<void> => {
  return new Promise(resolve => setTimeout(resolve, ms))
}
/**
 * Creates a debounced version of a function
 */
function debounce<T extends (...args: List[any]) => any>(
  fn: T,
  ms: float
 ...
 */
function throttle<T extends (...args: List[any]) => any>(
  fn: T,
  ms: float
): (...args: Parameters<T>) => Promise<ReturnType<T>> {
 ...
 */
function memoizeAsync<T extends (...args: List[any]) => Promise<any>>(
  fn: T,
  ...
  const cache = new Map<string, { value: ReturnType<T>; timestamp: float }>()
