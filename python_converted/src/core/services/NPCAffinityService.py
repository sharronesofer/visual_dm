...
class NPCAffinityService {
   ...
   */
  public getAffinity(npcId1: str, npcId2: str): NPCAffinity {
   ...
   */
  public updateAffinity(npcId1: str, npcId2: str, change: float, context?: Record<string, any>): NPCAffinity {
   ...
   */
  public getAllAffinitiesForNPC(npcId: str): NPCAffinity[] {
   ...
   */
  private calculateRelationshipType(score: float): RelationshipType {
   ...
   */
  private affinityKey(npcId1: str, npcId2: str): str {
