 ...
 */
function regionToTactical(regionGrid: HexGrid, centerQ: float, centerR: float, size: float): TacticalHexGrid {
 ...
 */
function tacticalToRegion(regionGrid: HexGrid, tacticalGrid: TacticalHexGrid, centerQ: float, centerR: float): void {
} 