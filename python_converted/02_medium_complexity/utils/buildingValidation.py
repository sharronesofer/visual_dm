...
class ValidationResult:
    isValid: bool
    errors: List[str]
function validateBuildingBase(building: BuildingBase): \'ValidationResult\' {
...
function validateSocialBuilding(building: SocialBuilding): \'ValidationResult\' {
...
function validateDungeonStructure(structure: DungeonStructure): \'ValidationResult\' {
...
function validateExplorationFeature(feature: ExplorationFeature): \'ValidationResult\' {
...
function validateInn(inn: Inn): \'ValidationResult\' {
...
function validateShop(shop: Shop): \'ValidationResult\' {
...
function isValidCoordinate(coord: Coordinate): bool {
  return typeof coord.x === 'number' && typeof coord.y === 'number'
}
function isValidTimeRange(time: Dict[str, Any]): bool {
  return (
