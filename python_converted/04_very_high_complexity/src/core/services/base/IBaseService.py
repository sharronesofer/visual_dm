 ...
 */
interface IBaseService<T extends BaseEntity, C = Partial<T>, U = Partial<T>> {
  /**
   * Create a new entity
   ...
   */
  update(id: str, data: U): Promise<T>
  /**
   * Delete an entity by ID (soft delete)
   * @param id Entity ID
   * @returns Promise resolving to boolean indicating success
   */
  delete(id: str): Promise<boolean>
  /**
   * Hard delete an entity by ID (permanent deletion)
   * @param id Entity ID
   * @returns Promise resolving to boolean indicating success
   */
  hardDelete(id: str): Promise<boolean>
  /**
   * Check if an entity exists
   * @param id Entity ID
   * @returns Promise resolving to boolean indicating existence
   */
  exists(id: str): Promise<boolean>
  /**
