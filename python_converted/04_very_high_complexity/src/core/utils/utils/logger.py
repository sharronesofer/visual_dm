...
class LoggerConfig:
    ...
    customHandlers?: List[LogHandler]
/**
 * Log handler interface
 */
class LogHandler:
    handle(entry: LogEntry): None
/**
...
class Logger {
  ...
  private handlers: List[LogHandler]
   ...
   * Log a debug message
   */
  public debug(message: str, context?: Record<string, any>): void {
    this.log(LogLevel.DEBUG, message, context)
  }
  /**
   * Log an info message
   */
  public info(message: str, context?: Record<string, any>): void {
    this.log(LogLevel.INFO, message, context)
  }
  /**
   * Log a warning message
   */
  public warn(message: str, context?: Record<string, any>): void {
