...
namespace VisualDM.Animation
{
    ...
    public class AnimationSyncSystem
    {
        ...
        public AnimationTimeline StartSynchronizedAnimation(string animationName, float duration, float playbackRate = 1.0f)
        {
            ...
            {
                timeline.RegisterEvent(trig.NormalizedTime, () => FeedbackManager.Instance.EnqueueFeedback(new FeedbackEffect
                {
                    Type = FeedbackType.Particle,
                    Priority = 0,
        ...
        public void UpdateAll(float deltaTime)
        {
            ...
            foreach (var b in activeBlends)
                b.Update(deltaTime);
            FeedbackManager.Instance.Update(deltaTime);
        ...
        public void RegisterFeedback(FeedbackEffect effect)
        {
            FeedbackManager.Instance.EnqueueFeedback(effect);
        }
