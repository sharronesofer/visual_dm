    ...
    public class WorldManagementPanel : PanelBase
    {
        ...
        public override void Initialize(params object[] args)
        {
            try
            {
                ...
                titleLabel.text = "World Management";
                ...
                // World list placeholder (to be replaced with actual list rendering)
                ...
                listLabel.text = "[World List Here]";
                ...
                btn.Label = "Add World";
                btn.OnClick = () => { /* TODO: Implement add world logic */ };
            }
            catch (Exception ex)
            {
                VisualDM.Utilities.ErrorHandlingService.Instance.LogException(ex, "Failed to initialize World Management Panel.", "WorldManagementPanel.Initialize");
