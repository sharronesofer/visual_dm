    ...
    public class PowerAnalysisDashboard : MonoBehaviour
    {
        ...
        void BuildUI()
        {
            try
            {
                ...
                // Search field
                _searchField = CreateInputField(_rootPanel, new Vector2(500, -10), OnSearchChanged);
                // Sort dropdown
        ...
        InputField CreateInputField(Transform parent, Vector2 pos, Action<string> onChanged)
        {
