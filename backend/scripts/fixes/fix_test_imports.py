...
'''
    ...
    def fix_events_init(self, init_path: Path):
        ...
        if "EventBase" not in content:
            ...
            content += '\n\nfrom backend.systems.base import backend.systems.dispatcher import EventDispatcher\n'
            init_path.write_text(content)
...
'''
    ...
    def fix_shared_module(self):
        ...
        if shared_init.exists():
            ...
            # Add common exports
            if "from backend.infrastructure.shared.models import" not in content:
                content += "\n# Common shared exports\ntry:\n    from backend.infrastructure.shared.models.base import Base\nexcept ImportError:\n    Base = object\n"
