...
try:
    from backend.systems.character import Character, CharacterModel
except ImportError:
    # Create placeholder classes if models don't exist
    class Character:
    class CharacterModel:
try:
    from backend.systems.stats import CharacterStats
except ImportError:
...
try:
    from backend.systems.character_service import CharacterService
except ImportError:
    class CharacterService:
try:
    from backend.systems.goal_service import GoalService
except ImportError:
    from backend.systems.goals import GoalService

try:
    from backend.systems.mood_service import MoodService  
except ImportError:
    from backend.systems.mood import MoodService
...
try:
    from backend.systems.rumor_utils import RumorUtils, create_rumor
except ImportError:
    class RumorUtils:
