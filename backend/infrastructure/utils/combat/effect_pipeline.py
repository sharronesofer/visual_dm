...
This module manages combat effects in the Visual DM system. It provides:
1. Effect application and removal
...
class EffectStackingBehavior(Enum):
    ...
    CHARGES = auto()  # Effect gains additional charges
...
class EffectType(Enum):
    ...
    DAMAGE_OVER_TIME = auto()  # Deals damage each turn
    HEAL_OVER_TIME = auto()  # Heals each turn
    RESISTANCE = auto()  # Reduces damage from certain types
    VULNERABILITY = auto()  # Increases damage from certain types
    IMMUNITY = auto()  # Prevents damage/effects of certain types
...
class CombatEffect:
    ...
    def on_turn_start_trigger(self, target) -> None:
        """
    ...
    def on_turn_end_trigger(self, target) -> None:
        """
    ...
    def on_stacked_trigger(self, target, stack_count) -> None:
        """
    ...
    def stack(self, new_effect: 'CombatEffect') -> bool:
        ...
        Args:
            new_effect: The effect to stack with
        ...
        elif self.stacking_behavior == EffectStackingBehavior.CHARGES:
            self.current_stacks += 1
            
        self.current_stacks = min(self.current_stacks, self.max_stacks)
        return True
    ...
    def modify_damage(self, damage, damage_type: str = None) -> float:
        """
...
class EffectPipeline:
    ...
    def get_applied_effects(self, combatant) -> List[CombatEffect]:
        """
    ...
    def _get_matching_effects(self, combatant, effect_type: Optional[EffectType] = None,
    ...
    def apply_effect(self, source, target, effect) -> bool:
        """
        ...
        if existing.stacking_behavior == EffectStackingBehavior.CHARGES and effect.current_stacks > existing.current_stacks:
    ...
    def remove_effect(self, target, effect) -> bool:
        """
    ...
    def remove_effects_by_type(self, target, effect_type) -> int:
        """
    ...
    def remove_effects_by_name(self, target, effect_name) -> int:
        """
    ...
    def clear_effects(self, target) -> int:
        """
    ...
    def clear_all_effects(self) -> int:
        ...
        for target_id in list(self._effects.keys()):
            ...
            for effect in effects_to_remove:
                ...
                dummy_target = type('DummyTarget', (), {'character_id'})
                if self.remove_effect(dummy_target, effect):
                    total_count += 1
        
        return total_count
    
    def process_turn_start(self, combatant) -> None:
        """
    ...
    def process_turn_end(self, combatant) -> None:
        """
    ...
    def process_before_action(self, source, action, target) -> bool:
        """
    ...
    def process_after_action(self, source, action, target) -> None:
        """
    ...
    def modify_damage(self, source, target, damage, damage_type: str = None) -> float:
        """
    ...
    def process_damage(self, target, damage) -> None:
        """
    ...
    def process_deal_damage(self, source, target, damage) -> None:
        """
    ...
    def process_death(self, target) -> None:
        """
    ...
    def process_kill(self, source, target) -> None:
        """
    ...
    def process_heal(self, source, target, healing) -> None:
        """
    ...
    def process_healed(self, target, source, healing) -> None:
        """
    ...
    def is_immune_to_effect(self, target, effect) -> bool:
        """
