...
from backend.infrastructure.utils.combat.object_pool import ObjectPool
from backend.infrastructure.utils.combat.effect_pipeline import CombatEffect, EffectType
...
class EffectVisualizer:
    ...
    def __init__(self):
        ...
        # Color mapping for different effect types (R, G, B, A)
        self.effect_type_colors = {
