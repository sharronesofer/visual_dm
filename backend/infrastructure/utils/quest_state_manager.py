...
from backend.infrastructure.systems.quest.repositories import QuestRepository
...
class QuestStateManager:
    ...
    def __init__(self):
        ...
        self.npc_quest_repo = NPCQuestRepository()
    ...
    def update_step_status(self, quest_id: str, step_id: int, completed: bool) -> Dict[str, Any]:
        ...
        """
        # Get the quest
        quest_data = self.quest_repo.get_by_id(quest_id)
        if not quest_data:
        ...
        self.quest_repo.update(quest_id, quest_data)
    ...
    def accept_quest(self, quest_id: str, player_id: str) -> Dict[str, Any]:
        ...
        self.npc_quest_repo.create_journal_entry(journal_entry)
