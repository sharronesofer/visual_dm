"""
Infrastructure Async Database Setup

Centralized async database configuration and session management
for all systems requiring async operations.
"""

from sqlalchemy.ext.asyncio import create_async_engine, AsyncSession
from sqlalchemy.orm import sessionmaker

from backend.infrastructure.shared.utils.config import config as app_config # Get main app config
