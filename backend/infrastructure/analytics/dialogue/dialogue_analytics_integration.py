...
from backend.infrastructure.analytics.event_logger import EventLogger
...
class DialogueAnalyticsIntegration:
    ...
    def export_dialogue_for_training(
        ...
        try:
            ...
            # Export to file
            if not export_path:
                export_dir = "data/system/runtime/analytics/dialogue_exports"
            ...
            default_path = "data/system/runtime/analytics/dialogue_exports/dialogue_export_error.json"
            return default_path
