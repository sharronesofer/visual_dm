...
This module defines the data models for the analytics system according to
...
class AnalyticsEntity(Base):
    ...
    __tablename__ = f"analytics_entities"
    ...
    def __repr__(self):
        return f"<AnalyticsEntity(id={self.id}, name={self.name})>"
