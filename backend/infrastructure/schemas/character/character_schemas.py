...
class CharacterListResponseSchema(BaseModel):
    """Schema for character list responses with pagination."""
...
# Export schemas
__all__ = ['CharacterSchema', 'CharacterCreateSchema', 'CharacterUpdateSchema', 'CharacterListResponseSchema']
