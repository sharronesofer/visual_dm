...
class InventoryExporter:
    ...
    def export_to_json(inventory_id: int) -> Tuple[bool, Optional[str], Optional[Dict[str, Any]]]:
        ...
        try:
            ...
            export_data = {
                ...
                "items": items_data,
                "stats": self._calculate_inventory_stats(inventory_id),
    ...
    @staticmethod
    def _calculate_inventory_stats(inventory_id: int) -> Dict[str, Any]:
        """Calculate inventory statistics without circular import"""
        # Placeholder implementation - should be replaced with proper stats calculation
        return {
            "total_items": 0,
            "total_weight": 0.0,
            "total_value": 0
