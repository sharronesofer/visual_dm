...
from backend.infrastructure.memory_utils.memory_utilities import store_interaction
from backend.systems.npc.utils.legacy.npc_rumor_utils import share_rumors_between_npcs
# Commented out missing npc relationships utils import
# from backend.systems.npc.npc_relationships_utils import update_npc_location

# Mock function for missing import
def update_npc_location(npc_id: str):
    """Mock function for updating NPC location"""
    return {"status": "success", "message": f"NPC {npc_id} location updated (mock)", "npc_id": npc_id}
