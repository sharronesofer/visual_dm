...
FastAPI router for NPC character-specific operations.
"""
...
# Use local infrastructure imports for models
from backend.infrastructure.systems.npc.models.models import CreateNpcRequest, UpdateNpcRequest, NpcResponse
