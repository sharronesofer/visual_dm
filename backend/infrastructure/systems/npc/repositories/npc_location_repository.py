...
Repository for NPC location and movement tracking.
Handles location history, movement patterns, and regional population data.
"""
...
from backend.infrastructure.systems.npc.models.models import NpcEntity, NpcLocationHistory
