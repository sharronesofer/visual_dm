...
# Add missing classes as stubs for now
class WorldTime(GameTime):
    """Stub for WorldTime - extends GameTime for now"""
    pass

class CalendarEvent(TimeEvent):
    """Stub for CalendarEvent - extends TimeEvent for now"""
    pass
