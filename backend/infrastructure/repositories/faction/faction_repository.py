...
from backend.infrastructure.schemas.faction.faction_types import FactionType, FactionAlignment, DiplomaticStance

class FactionRepository:
    """Repository for faction data persistence."""
    
    def __init__(self, data_dir: str = "data/systems/faction"):
        """
