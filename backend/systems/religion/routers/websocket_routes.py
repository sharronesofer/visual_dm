"""
Religion WebSocket Routes - FastAPI WebSocket endpoints for real-time religion updates.

Provides WebSocket endpoints for real-time religion system communication including
religion creation/updates, membership changes, religious events, and narrative updates.
"""
