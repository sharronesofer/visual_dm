...
class NpcEntity(Base, UUIDMixin, TimestampMixin):
...
class NpcMemory(Base, UUIDMixin, TimestampMixin):
...
class NpcFactionAffiliation(Base, UUIDMixin, TimestampMixin):
...
class NpcRumor(Base, UUIDMixin, TimestampMixin):
...
class NpcLocationHistory(Base, UUIDMixin, TimestampMixin):
    ...
    def __repr__(self):
        return f"<NpcLocationHistory(npc_id={self.npc_id}, location={self.location}, motive={self.travel_motive})>"


class NpcMotif(Base, UUIDMixin, TimestampMixin):
