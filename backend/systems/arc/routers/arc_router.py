...
from backend.systems.arc.repositories.arc_progression_repository import ArcProgressionRepository
from backend.systems.arc.repositories.arc_completion_record_repository import ArcCompletionRecordRepository
