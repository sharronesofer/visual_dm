...
This module provides classes for managing locations and containers that hold loot.
"""
...
# from .item import BaseItem # Could be imported for type hinting or explicit relationship
# from .shop import Shop     # Could be imported for type hinting or explicit relationship
import enum
...
class ContainerContent(LootBase):
    ...
    item = relationship('BaseItem', back_populates='container_contents') # Relies on BaseItem from item.py being in scope
