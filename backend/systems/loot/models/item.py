...
This module provides the BaseItem class and related enums for the loot system.
All lootable items inherit from the BaseItem class.
"""
...
class BaseItem(LootBase):
    ...
    # Relationships - using string references for lazy resolution
