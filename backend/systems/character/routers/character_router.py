...
from backend.systems.character.schemas.character_schemas import (
...
async def list_characters(
    ...
    try:
        ...
        return CharacterListResponseSchema(
            characters=[CharacterResponseSchema.from_orm(char) for char in characters],
            total=total_count,
            skip=skip,
            limit=limit
        )
...
@router.get("/{character_id}", response_model=CharacterResponseSchema)
...
@router.get("/uuid/{character_uuid}", response_model=CharacterResponseSchema)
...
@router.put("/{character_id}", response_model=CharacterResponseSchema)
...
@router.post("/{character_id}/level-up", response_model=CharacterResponseSchema)
...
@router.post("/{character_id}/heal", response_model=CharacterResponseSchema)
...
@router.post("/{character_id}/damage", response_model=CharacterResponseSchema)
