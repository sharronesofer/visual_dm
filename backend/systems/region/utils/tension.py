...
from backend.infrastructure.utils import TensionError
# Temporarily commented out to avoid circular import
# from backend.systems.world_state.utils.events import log_world_event
...
def log_world_event(*args, **kwargs):
    """Temporary placeholder to avoid circular import"""
    pass 