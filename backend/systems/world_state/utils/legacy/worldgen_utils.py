"""
World generation utilities for creating regions, biomes, and features.

DEPRECATED: This file uses non-canonical imports and should be updated to use
canonical backend.systems and backend.infrastructure imports.
"""
...
# DEPRECATED IMPORT - should use backend.infrastructure.shared.exceptions
from app.core.utils.error_utils import GenerationError
# DEPRECATED IMPORT - should use backend.infrastructure.data.loaders
...
class WorldGenerator:
    ...
    def __init__(self, seed: Optional[int] = None, data_dir: str = "data/builders"):
