...
def simulate_world_events(event_count=1000, event_types=None, regions=None, factions=None):
    """
    ...
    """
    event_types = event_types or ["arc_failure", "war_outbreak", "tension_spike", "metropolis_assigned"]
