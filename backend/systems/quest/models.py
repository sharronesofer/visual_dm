...
class QuestData:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'chain_prerequisites': self.chain_prerequisites,
            'chain_unlocks': self.chain_unlocks,
...
class QuestValidationService(Protocol):
    """Service interface for quest validation"""
...
class QuestGenerationService(Protocol):
    """Service interface for quest generation"""
