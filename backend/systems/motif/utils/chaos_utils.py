#This module governs the injection and escalation of narrative chaos, driven by motif pressure, NPC thresholds, and player/world triggers. It is a key system for unpredictable narrative emergence.
#It connects deeply with motif, npc, region, memory, narrative, and world log systems.
    
import random
# from firebase_admin import db  # TODO: Replace with proper database integration
from datetime import datetime
from backend.systems.motif.motif_utils import roll_new_motif
from backend.systems.motif.motif_engine_class import MotifEngine
from backend.systems.npc.utils.legacy.npc_rumor_utils import sync_event_beliefs
