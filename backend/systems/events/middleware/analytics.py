...
This middleware implements the Analytics System described in the Development Bible,
with structured event storage, dataset generation capabilities, and organization
...
class AnalyticsService:
    """
    Singleton service for analytics data capture and processing.
...
async def analytics_middleware(event: EventBase, next_middleware: Callable) -> EventBase:
    ...
    analysis and dataset generation for LLM training.
