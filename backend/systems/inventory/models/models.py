...
This module defines the data models for the inventory system according to
...
class InventoryBaseModel(SharedBaseModel):
    """Base model for inventory system with common fields"""
...
class InventoryModel(InventoryBaseModel):
    """Primary model for inventory system"""
    ...
    status: str = Field(default="active", description="Status of the inventory")
...
class InventoryListResponse(BaseModel):
    """Response model for inventory lists"""
