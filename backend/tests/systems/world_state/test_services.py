"""
Test module for world_state.services
...
try:
    from backend.infrastructure.systems.world_state import services
except ImportError:
    pytest.skip(f"Module backend.systems.world_state.services not found", allow_module_level=True)
