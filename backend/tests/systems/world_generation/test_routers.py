"""
Test routers for world_generation system.
...
class TestWorld_GenerationRouters:
    """Test suite for world_generation routers."""
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_world_generation_data):
...
class TestWorld_GenerationRoutersIntegration:
    """Integration tests for world_generation routers."""
