"""
Test module for world_generation.services
...
try:
    from backend.systems.world_generation import services
except ImportError:
    pytest.skip(f"Module backend.systems.world_generation.services not found", allow_module_level=True)
