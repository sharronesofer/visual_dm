"""
Test module for world_generation.models
...
try:
    from backend.systems.world_generation.models import models
except ImportError:
    pytest.skip(f"Module backend.infrastructure.world_generation.models not found", allow_module_level=True)
