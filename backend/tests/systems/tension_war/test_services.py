"""
Test module for tension_war.services
...
try:
    from backend.systems.tension_war import services
except ImportError:
    pytest.skip(f"Module backend.systems.tension_war.services not found", allow_module_level=True)
