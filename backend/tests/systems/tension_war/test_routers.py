"""
Test routers for tension_war system.
...
from backend.systems.tension_war import routers


class TestTension_WarRouters:
    """Test suite for tension_war routers."""
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_tension_war_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_tension_war_data):
...
class TestTension_WarRoutersIntegration:
    """Integration tests for tension_war routers."""
