"""
Test module for tension_war.models
...
try:
    from backend.systems.tension_war import models
except ImportError:
    pytest.skip(f"Module backend.systems.tension_war.models not found", allow_module_level=True)
