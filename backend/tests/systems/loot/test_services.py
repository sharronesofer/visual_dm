...
try:
    from backend.systems.loot import services
except ImportError:
    pytest.skip(f"Module backend.systems.loot.services not found", allow_module_level=True)
