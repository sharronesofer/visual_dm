...
from backend.systems.loot import routers


class TestLootRouters:
    """Test suite for loot routers."""
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_loot_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_loot_data):
...
class TestLootRoutersIntegration:
    """Integration tests for loot routers."""
