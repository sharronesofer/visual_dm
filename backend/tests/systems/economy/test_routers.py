"""
Test routers for economy system.
...
from backend.systems.economy import routers


class TestEconomyRouters:
    """Test suite for economy routers."""
    ...
    @pytest.fixture
    def sample_economy_data(self):
        """Sample data for economy testing."""
        return {
            "id": str(uuid4()),
            "name": f"Test Economy",
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_economy_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_economy_data):
...
class TestEconomyRoutersIntegration:
    """Integration tests for economy routers."""
