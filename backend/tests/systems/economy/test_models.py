"""
Test module for economy.models
...
try:
    from backend.systems.economy import models
except ImportError:
    pytest.skip(f"Module backend.systems.economy.models not found", allow_module_level=True)
