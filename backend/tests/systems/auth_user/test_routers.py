"""
Test routers for auth_user system.
...
from backend.infrastructure.auth.auth_user import routers


class TestAuth_UserRouters:
    """Test suite for auth_user routers."""
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_auth_user_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_auth_user_data):
...
class TestAuth_UserRoutersIntegration:
    """Integration tests for auth_user routers."""
