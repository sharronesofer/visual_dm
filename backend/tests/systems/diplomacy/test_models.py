"""
Test module for diplomacy.models
...
try:
    from backend.systems.diplomacy import models
except ImportError:
    pytest.skip(f"Module backend.systems.diplomacy.models not found", allow_module_level=True)
