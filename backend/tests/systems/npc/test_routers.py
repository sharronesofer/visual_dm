...
from backend.systems.npc import routers


class TestNpcRouters:
    """Test suite for npc routers."""
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_npc_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_npc_data):
...
class TestNpcRoutersIntegration:
    """Integration tests for npc routers."""
