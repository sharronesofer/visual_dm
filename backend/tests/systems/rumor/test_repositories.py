...
from backend.systems.rumor import repositories


class TestRumorRepositories:
    """Test suite for rumor repositories."""
    ...
    @pytest.mark.asyncio
    async def test_repositories_basic_operations(self, mock_db_session, sample_rumor_data):
    ...
    @pytest.mark.asyncio
    async def test_repositories_validation(self, mock_db_session, sample_rumor_data):
