"""
Test routers for faction system.
...
from backend.systems.faction import routers


class TestFactionRouters:
    """Test suite for faction routers."""
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_faction_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_faction_data):
...
class TestFactionRoutersIntegration:
    """Integration tests for faction routers."""
