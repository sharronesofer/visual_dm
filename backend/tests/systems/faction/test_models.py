"""
Test module for faction.models
...
try:
    from backend.systems.faction import models
except ImportError:
    pytest.skip(f"Module backend.systems.faction.models not found", allow_module_level=True)
