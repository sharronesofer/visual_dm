"""
Test module for faction.services
...
try:
    from backend.systems.faction import services
except ImportError:
    pytest.skip(f"Module backend.systems.faction.services not found", allow_module_level=True)
