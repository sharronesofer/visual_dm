"""
Test module for storage.models
...
try:
    from backend.infrastructure.storage import models
except ImportError:
    pytest.skip(f"Module backend.systems.storage.models not found", allow_module_level=True)
