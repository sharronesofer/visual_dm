...
from backend.systems.quest import routers


class TestQuestRouters:
    """Test suite for quest routers."""
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_quest_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_quest_data):
...
class TestQuestRoutersIntegration:
    """Integration tests for quest routers."""
