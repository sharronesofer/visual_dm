...
class TestMotifRouters:
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_motif_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_motif_data):
...
class TestMotifRoutersIntegration:
    """Integration tests for motif routers."""
