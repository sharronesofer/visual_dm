"""
Test routers for combat system.
...
from backend.systems.combat import routers


class TestCombatRouters:
    """Test suite for combat routers."""
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_combat_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_combat_data):
...
class TestCombatRoutersIntegration:
    """Integration tests for combat routers."""
