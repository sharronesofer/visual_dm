"""
Test routers for integration system.
...
from backend.infrastructure.integration import routers


class TestIntegrationRouters:
    """Test suite for integration routers."""
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_integration_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_integration_data):
...
class TestIntegrationRoutersIntegration:
    """Integration tests for integration routers."""
