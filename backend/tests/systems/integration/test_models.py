"""
Test module for integration.models
...
try:
    from backend.infrastructure.integration import models
except ImportError:
    pytest.skip(f"Module backend.systems.integration.models not found", allow_module_level=True)
