"""
Test repositories for population system.
...
class TestPopulationRepositories:
    """Test suite for population repositories."""
    ...
    @pytest.mark.asyncio
    async def test_repositories_basic_operations(self, mock_db_session, sample_population_data):
    ...
    @pytest.mark.asyncio
    async def test_repositories_validation(self, mock_db_session, sample_population_data):
...
class TestPopulationRepositoriesIntegration:
    """Integration tests for population repositories."""
