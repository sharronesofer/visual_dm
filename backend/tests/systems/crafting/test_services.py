"""
Test module for crafting.services
...
try:
    from backend.systems.crafting import services
except ImportError:
    pytest.skip(f"Module backend.systems.crafting.services not found", allow_module_level=True)
