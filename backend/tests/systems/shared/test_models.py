...
try:
    from backend.infrastructure.shared import models
except ImportError:
    pytest.skip(f"Module backend.infrastructure.shared.models not found", allow_module_level=True)
