"""
Test module for shared.services
...
try:
    from backend.infrastructure.shared import services
except ImportError:
    pytest.skip(f"Module backend.infrastructure.shared.services not found", allow_module_level=True)
