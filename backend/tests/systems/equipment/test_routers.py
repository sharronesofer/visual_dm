...
from backend.systems.equipment import routers


class TestEquipmentRouters:
    """Test suite for equipment routers."""
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_equipment_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_equipment_data):
...
class TestEquipmentRoutersIntegration:
    """Integration tests for equipment routers."""
