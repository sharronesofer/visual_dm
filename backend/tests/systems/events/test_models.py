...
try:
    from backend.infrastructure.events import models
except ImportError:
    pytest.skip(f"Module backend.systems.events.models not found", allow_module_level=True)
