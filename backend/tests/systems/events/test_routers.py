"""
Test routers for events system.
...
from backend.infrastructure.events import routers


class TestEventsRouters:
    """Test suite for events routers."""
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_events_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_events_data):
...
class TestEventsRoutersIntegration:
    """Integration tests for events routers."""
