"""
Test module for events.services
...
try:
    from backend.infrastructure.events import services
except ImportError:
    pytest.skip(f"Module backend.systems.events.services not found", allow_module_level=True)
