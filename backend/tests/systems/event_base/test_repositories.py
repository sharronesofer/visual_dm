"""
Test repositories for event_base system.
...
class TestEvent_BaseRepositories:
    """Test suite for event_base repositories."""
    ...
    @pytest.mark.asyncio
    async def test_repositories_basic_operations(self, mock_db_session, sample_event_base_data):
    ...
    @pytest.mark.asyncio
    async def test_repositories_validation(self, mock_db_session, sample_event_base_data):
...
class TestEvent_BaseRepositoriesIntegration:
    """Integration tests for event_base repositories."""
