...
from backend.systems.poi import routers


class TestPoiRouters:
    """Test suite for poi routers."""
    ...
    @pytest.mark.asyncio
    async def test_routers_basic_operations(self, mock_db_session, sample_poi_data):
    ...
    @pytest.mark.asyncio
    async def test_routers_validation(self, mock_db_session, sample_poi_data):
...
class TestPoiRoutersIntegration:
    """Integration tests for poi routers."""
