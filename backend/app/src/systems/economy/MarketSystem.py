...
class MarketSystem {
  ...
  private readonly PRICE_UPDATE_INTERVAL = 60 * 60 * 1000 
   ...
   */
  public isMarketOpen(marketId: str): bool {
   ...
   */
  public cancelOffer(offerId: str, sellerId: str): bool {
   ...
   */
  private isOfferInMarket(offer: TradeOffer, marketId: str): bool {
    const market = this.markets.get(marketId)
    if (!market) return false
   ...
   */
  public getMarketActivity(marketId: str): float {
    const market = this.markets.get(marketId)
    if (!market) return 0
   ...
   */
  public getOffer(offerId: str): TradeOffer | undefined {
