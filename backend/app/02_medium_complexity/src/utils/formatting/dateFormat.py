 ...
 */
const formatISODate = (date: Date | string | number): str => {
  const dateObj = new Date(date)
 ...
 */
const formatRelativeTime = (date: Date | string | number): str => {
  const dateObj = new Date(date)
  const now = new Date()
 ...
 */
const formatDuration = (milliseconds: float): str => {
 ...
 */
const getWeekNumber = (date: Date | string | number): float => {
  const dateObj = new Date(date)
