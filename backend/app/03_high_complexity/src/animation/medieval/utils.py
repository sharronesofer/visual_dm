 ...
 */
const preloadMedievalTextures = async (): Promise<void> => {
  const loadTexture = (url: str): Promise<void> => {
...
const createPerformanceMonitor = () => {
  ...
  const updateMetrics = (currentTime: float) => {
 ...
 */
const shouldUseReducedAnimations = (): bool => {
 ...
 */
const getOptimizedAnimationConfig = (state: AnimationState) => {
