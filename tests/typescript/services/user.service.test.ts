...
import { User, CreateUserDTO, UpdateUserDTO } from '../../../src/services/user/types';
...
describe('UserService', () => {
  ...
  describe('Custom Methods', () => {
    ...
    it('should find user by email', async () => {
      mockAxios.onGet(`${baseURL}/by-email`, { params: { email: 'test@example.com' } })
    ...
    it('should find user by username', async () => {
      mockAxios.onGet(`${baseURL}/by-username`, { params: { username: 'testuser' } })
        .reply(200, { data: mockUser });
