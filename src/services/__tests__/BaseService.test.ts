...
import { ValidatableService } from '../../core/base/services';
...
class TestService extends ValidatableService<TestEntity> {
   ...
   */
  protected async executeUpdate(id: string, data: Partial<TestEntity>): Promise<TestEntity> {
   ...
   */
  protected async executeFindById(id: string): Promise<TestEntity | null> {
