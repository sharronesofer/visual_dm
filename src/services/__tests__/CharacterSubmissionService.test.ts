import CharacterSubmissionService from '../CharacterSubmissionService';
...
describe('CharacterSubmissionService', () => {
  ...
  describe('validation', () => {
    ...
    it('should validate attribute ranges', async () => {
      const invalidCharacter = {
        ...mockValidCharacter,
        attributes: {
          ...mockValidCharacter.attributes,
          strength: 25, // Invalid value
        },
      };
    ...
    it('should validate skill proficiencies count', async () => {
      const invalidCharacter = {
        ...mockValidCharacter,
        skills: mockValidCharacter.skills.slice(0, 1), // Too few skills
      };
    ...
    it('should validate spellcasting requirements for spellcasters', async () => {
      const invalidCharacter = {
        ...
        spellcasting: undefined, // Missing spellcasting info
      };
  ...
  describe('getSubmissionStatus', () => {
    it('should fetch submission status', async () => {
      const mockStatus = {
        data: { status: 'completed', message: 'Success' },
        error: null,
      };
