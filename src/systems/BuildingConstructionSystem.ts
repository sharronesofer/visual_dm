...
export class BuildingConstructionSystem {
  ...
  calculateConstructionCost(
    ...
    return {
      materials: {
        [material]: baseAmount * loadBearingMultiplier
      },
      time: baseAmount * materialProps.repairDifficulty * 60, // Convert to seconds
      laborCost: baseAmount * materialProps.repairDifficulty * 100 // Base labor cost
    };
  }
  ...
  canBuildAt(
    ...
    switch (elementType) {
      case 'door':
      case 'window':
        // Must have a supporting wall adjacent
