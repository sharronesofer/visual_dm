import { QuestMemoryIntegrator } from '../QuestMemoryIntegrator';
import { MemoryManager } from '../../../systems/npc/MemoryManager';
import { ConsequenceSystem, WorldState } from '../../consequences/ConsequenceSystem';
import { FactionQuestSystem, FactionQuestConfig } from '../../factions/FactionQuestSystem';
import { QuestType, QuestStatus, QuestEvent } from '../../../types/quests/quest';
...
describe('QuestMemoryIntegrator', () => {
  ...
  beforeEach(() => {
    const mockWorldState: WorldState = {
      ...
      economyFactors: { inflation: 1.0, resourceScarcity: {} },
      activeEffects: [],
      customState: {}
    };
    ...
    it('should handle faction-specific quest events', async () => {
      ...
      expect(memoryManager.addMemory).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          type: MemoryEventType.QUEST,
          details: expect.objectContaining({
            factionImpact: { [FactionType.MERCHANTS]: 15, [FactionType.WARRIORS]: -5 },
            description: questEvent.description,
            emotionalImpact: expect.any(Number),
    ...
    it('should retrieve quest-related memories for an NPC', async () => {
      const mockMemories: MemoryEvent[] = [{
        ...
        details: {
          ...
          outcome: QuestStatus.COMPLETED,
          description: 'A faction quest memory',
          emotionalImpact: 0.7,
          playerActions: []
        },
      ...
      const mockMemories: MemoryEvent[] = [
        {
          ...
          details: {
            questId: 'quest-old',
            questType: QuestType.MINOR,
            outcome: QuestStatus.COMPLETED,
            description: 'An old minor quest memory',
            emotionalImpact: 0.3,
            playerActions: []
          },
          participants: [mockPlayerId, mockNpcId],
        ...
        },
        {
          ...
          importance: 0.8,
          details: {
            questId: 'quest-recent',
            questType: QuestType.MAJOR,
            outcome: QuestStatus.COMPLETED,
            description: 'A recent major quest memory',
            emotionalImpact: 0.8,
            playerActions: []
          },
          participants: [mockPlayerId, mockNpcId],
    ...
    it('should modify dialogue based on relevant quest memories', async () => {
      const mockMemories: MemoryEvent[] = [{
        ...
        details: {
          ...
          questType: QuestType.MAJOR,
          outcome: QuestStatus.COMPLETED,
          description: 'A heroic quest completion',
          emotionalImpact: 0.8,
          playerActions: ['saved_village']
        },
        participants: [mockPlayerId, mockNpcId],
      ...
      const mockMemories: MemoryEvent[] = [
        {
          ...
          details: {
            ...
            questType: QuestType.MAJOR,
            outcome: QuestStatus.COMPLETED,
            description: 'A successful major quest',
            emotionalImpact: 0.8,
            playerActions: ['heroic_deed']
          },
          participants: [mockPlayerId, mockNpcId],
          tags: ['quest_major', 'outcome_completed', 'heroic']
        }
      ...
      const mockMemories: MemoryEvent[] = [
        {
          ...
          details: {
            ...
            questType: QuestType.FACTION,
            outcome: QuestStatus.FAILED,
            description: 'A failed faction quest',
            emotionalImpact: -0.5,
            playerActions: ['betrayal']
          },
          participants: [mockPlayerId, mockNpcId],
