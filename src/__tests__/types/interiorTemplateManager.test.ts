...
import { RoomType, InteriorTemplate, RoomLayout, FurnitureRule, DecorationScheme, NPCZoneDefinition, InteractiveObjectRule } from '../../types/interiors/template';
...
describe('InteriorTemplateManager', () => {
  ...
  beforeEach(() => {
    ...
    baseRoom = {
      ...
      minSize: { width: 2, length: 2 },
      maxSize: { width: 4, length: 4 },
      requiredConnections: [],
      optionalConnections: [],
      priority: 1,
      placementRules: []
