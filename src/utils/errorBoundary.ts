...
interface ErrorBoundaryOptions {
  ...
  enrichContext?: (error: Error) => Record<string, any>;
}
 ...
 * @param options Configuration options for the error boundary
 */
export function createExpressErrorBoundary(options: ErrorBoundaryOptions = {}) {
 ...
 */
export function withErrorLogging<T extends AsyncFunction<any>>(
  handler: T,
  customLogger?: Logger
): T {
 ...
 */
export function processErrorStack(error: Error): Record<string, any> {
