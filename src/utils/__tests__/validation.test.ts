...
import { CharacterData, RaceType, ClassType, BackgroundType, Attributes } from '../../types/character';
  ...
  describe('validateCharacter', () => {
    ...
    it('should validate required fields', () => {
      const invalidCharacter = {
        ...validCharacter,
        name: '',
        race: { ...mockRace, name: '' as any },
        class: { ...mockClass, name: '' as any },
      };
...
describe('Validation Utilities', () => {
  ...
  describe('String Validations', () => {
    ...
    it('isURL should validate URLs', () => {
      expect(isURL('https://example.com')).toBe(true);
      expect(isURL('http://sub.example.com/path?query=1')).toBe(true);
      expect(isURL('invalid')).toBe(false);
      expect(isURL('http://')).toBe(false);
