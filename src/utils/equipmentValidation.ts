import { Equipment, StarterKit } from '../types/character';
...
export const validateEquipmentSelection = (selectedKit: StarterKit | null): ValidationResult => {
...
export const validateEquipmentItem = (item: Equipment): ValidationResult => {
  const result: ValidationResult = {
    isValid: true,
    errors: [],
    warnings: [],
...
export const validateEquipmentCompatibility = (
  equipment: Equipment[],
