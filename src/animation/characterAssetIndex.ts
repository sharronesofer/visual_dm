// characterAssetIndex.ts
// Asset index and metadata for modular character sprite layers
 ...
 */
export type CharacterAssetIndex = {
  [layer in CharacterSpriteLayerType]?: {
    [variant: string]: CharacterAssetMeta[];
  };
};
 ...
 */
export const characterAssetIndex: CharacterAssetIndex = {
