import { Character, CharacterStats, CalculatedStats, StatModifier } from './types';
...
export class StatDisplay {
  ...
  private formatStatName(stat: keyof CharacterStats): string {
  ...
  private createTooltipContent(stat: keyof CharacterStats, modifiers: StatModifier[]): string {
