...
import type { ValidationRule, FieldConfig } from '../../utils/validationUtils';
...
describe('useFormValidation', () => {
  ...
  it('should validate all fields', async () => {
    ...
    const mockValidations = {
      username: { isValid: true, error: null, warning: null },
      email: { isValid: true, error: null, warning: null },
    };
  ...
  it('should handle async validation', async () => {
    const asyncConfig: Record<string, FieldConfig> = {
      ...
      username: {
        ...mockConfig.username,
        asyncValidation: async (value: string) => value === 'available',
      },
    };
