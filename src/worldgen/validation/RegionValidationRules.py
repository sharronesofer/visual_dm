 ...
 */
abstract class RegionValidationRule implements IValidationRule<Region> {
 ...
 */
class RegionStructureValidationRule extends RegionValidationRule {
    constructor() {
        super(
 ...
 */
class CellCoordinatesValidationRule extends RegionValidationRule {
    constructor() {
        super(
 ...
 */
class BiomeAdjacencyValidationRule extends RegionValidationRule {
 ...
 */
class TerrainDistributionValidationRule extends RegionValidationRule {
 ...
 */
class CompositeRegionValidationRule extends RegionValidationRule {
 ...
 */
function createStandardRegionValidationRules(): CompositeRegionValidationRule {
