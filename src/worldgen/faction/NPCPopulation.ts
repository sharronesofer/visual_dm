import { FactionType, FactionNPC } from './types';

const baseNPCs: Record<FactionType, { role: string; count: number; hierarchyLevel: number; behaviorProfile: string }[]> = {
  guild: [
