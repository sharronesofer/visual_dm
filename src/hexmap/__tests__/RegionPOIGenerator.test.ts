...
import { generatePOIs, POITemplate, generateResources, ResourceTemplate, POIInstance } from '../RegionPOIGenerator';
import { discoverPOI, discoverResource, queryNearbyPOIs, queryNearbyResources, ResourceInstance } from '../RegionPOIGenerator';
...
describe('generatePOIs', () => {
  ...
  it('places POIs only on allowed terrains', () => {
    ...
    // Set all to plains for simplicity
  ...
  it('template rarity affects distribution', () => {
    ...
    // Village (rarity 0.2) should be more common than ruin (rarity 0.8)
...
describe('generateResources', () => {
  ...
  it('can cluster resources', () => {
    ...
    // At least one cluster (adjacent resources)
  ...
  it('can place resources near POIs', () => {
    ...
    // At least one resource within distance 2 of the POI
