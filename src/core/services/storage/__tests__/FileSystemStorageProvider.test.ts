import { FileSystemStorageProvider, FileSystemStorageConfig } from '../FileSystemStorageProvider';
...
describe('FileSystemStorageProvider', () => {
  ...
  describe('getUrl', () => {
    it('should generate correct URL', async () => {
      ...
      expect(url).toBe('http://example.com/files/test/file.txt');
    });
  ...
  describe('list', () => {
    ...
    it('should list files in root directory', async () => {
      ...
      expect(items).toHaveLength(2); // file1.txt and dir/
    ...
    it('should list files in subdirectory', async () => {
      ...
      expect(items).toHaveLength(2); // file2.txt and subdir/
