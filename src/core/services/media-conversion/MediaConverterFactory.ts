import { IMediaConverterFactory, IMediaConverter, MediaType } from './types';
 ...
 */
export class MediaConverterFactory implements IMediaConverterFactory {
   ...
   */
  public isSupported(mediaType: MediaType): boolean {
