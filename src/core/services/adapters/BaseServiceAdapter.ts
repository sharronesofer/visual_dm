import { BaseService, BaseEntity, BaseQueryParams, CacheOptions, ServiceResponse as BaseServiceResponse } from '../base.service';
...
> extends BaseService<T> {
  ...
  constructor(resourcePath: string, options = {}) {
