...
import { IValidatableService } from '../interfaces/validatable.interface';
import { ValidationResult } from '../types/common';

/**
 * Abstract validatable service class that extends BaseService and implements IValidatableService
 */
export abstract class ValidatableService<T extends BaseEntity> extends BaseService<T> implements IValidatableService<T> {
